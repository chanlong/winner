...
public class TemplateResolver extends AbstractResolver {
        ...
        for (IBodyElement element : bodyElements) {
            ...
            if (element.getElementType() == BodyElementType.PARAGRAPH) {
                ...
                for (XWPFTableRow row : rows) {
                    ...
                    cells.forEach(cell -> addNewMeta(metaTemplates, stack, resolveBodyElements(cell.getBodyElements())));
                }
            }
        }
    ...
    private void addNewMeta(final List<MetaTemplate> metaTemplates, final Deque<BlockTemplate> stack, List<? extends MetaTemplate> newMeta) {
        if (stack.isEmpty()) {
    ...
    private <T extends MetaTemplate> void addNewMeta(final List<MetaTemplate> metaTemplates, final Deque<BlockTemplate> stack, T newMeta) {
